...
if deploy_model:
    ...
    model_tags[
        'details'] = 'This model was developed for automatically classifying the surge price'
    ...
    model = Model.register(
        model_path='model.joblib',  # this points to a local file
        model_name=args.model_name,  # this is the name the model is registered as
        tags=model_tags,
        description=model_description,
        workspace=run.experiment.workspace,
        datasets=[('training data', surge_ds)])
